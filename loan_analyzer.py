...
average_loan_price = sum(loan_costs) / 5
print(average_loan_price)
print(f"The average loan value is ${average_loan_price}.")
...
print(round(fair_value,2))  
print(f" The fair value of these loans is {round(fair_value,2)}")
...
if fair_value >= (int(loan["loan_price"])):
